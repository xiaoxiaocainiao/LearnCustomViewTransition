//
//  CustomDismissAnimationWithInteractiveViewController.swift
...
class CustomDismissAnimationWithInteractiveViewController: UIViewController, UIViewControllerTransitioningDelegate {
    
    private let _dimissAnimation = CustomDismissAnimation()
    private let _customDismissInteractiveTransition = CustomDismissInteractiveTransition()
    ...
    func showPresent() {
        ...
        _customDismissInteractiveTransition.attachToViewController(viewController)
    ...
    func interactionControllerForDismissal(using animator: UIViewControllerAnimatedTransitioning) -> UIViewControllerInteractiveTransitioning? {
        return _customDismissInteractiveTransition.transitionInProgress() ? _customDismissInteractiveTransition : nil
    }
