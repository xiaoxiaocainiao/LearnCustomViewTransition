//
//  CustomPresentInteractiveTransition.swift
...
class CustomPresentInteractiveTransition: UIPercentDrivenInteractiveTransition {
    private var _fromViewController: UIViewController!
    private var _toViewController: UIViewController!
    ...
    func attachToViewController(fromViewController: UIViewController, toViewController: UIViewController) {
        _fromViewController = fromViewController
        _toViewController = toViewController
        setupGestureRecognizer(view: _fromViewController.view)
    }
    ...
    func handlePanGesture(gestureRecognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            ...
            _fromViewController.present(_toViewController, animated: true, completion: nil)
        case .changed:
